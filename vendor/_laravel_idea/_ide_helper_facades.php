...
namespace Webklex\IMAP\Facades {
    ...
    /**
     * @see \Webklex\PHPIMAP\Client::disconnect
     * @method static \Webklex\PHPIMAP\Client disconnect()
     * @see \Webklex\PHPIMAP\ClientManager::getDefaultAccount
     * @method static string getDefaultAccount()
     * @see \Webklex\PHPIMAP\ClientManager::setConfig
     * @method static \Webklex\PHPIMAP\ClientManager setConfig(array|string $config)
     * @see \Webklex\PHPIMAP\Client::getFolderByPath
     * @method static mixed getFolderByPath($folder_path)
     * @see \Webklex\PHPIMAP\Client::checkFolder
     * @method static false|object checkFolder($folder)
     * @see \Webklex\PHPIMAP\Client::getConnection
     * @method static bool|\Webklex\PHPIMAP\Connection\Protocols\Protocol|\Webklex\PHPIMAP\Connection\Protocols\ProtocolInterface getConnection()
     * @see \Webklex\PHPIMAP\Client::createFolder
     * @method static bool createFolder(string $folder, bool $expunge = true)
     * @see \Webklex\PHPIMAP\Client::getTimeout
     * @method static int getTimeout()
     * @see \Webklex\PHPIMAP\Client::getFolderPath
     * @method static null|string getFolderPath()
     * @see \Webklex\PHPIMAP\Client::setTimeout
     * @method static \Webklex\PHPIMAP\Connection\Protocols\Protocol setTimeout(int $timeout)
     * @see \Webklex\PHPIMAP\Client::getFolder
     * @method static mixed getFolder(string $folder_name, bool|null|string $delimiter = null)
     * @see \Webklex\PHPIMAP\Traits\HasEvents::setEvent
     * @method static void setEvent($section, $event, $class)
     * @see \Webklex\PHPIMAP\Client::openFolder
     * @method static bool|mixed openFolder(string $folder_path, bool $force_select = false)
     * @see \Webklex\PHPIMAP\Client::getDefaultAttachmentMask
     * @method static string getDefaultAttachmentMask()
     * @see \Webklex\PHPIMAP\Client::reconnect
     * @method static void reconnect()
     * @see \Webklex\PHPIMAP\Traits\HasEvents::setEvents
     * @method static void setEvents($events)
     * @see \Webklex\PHPIMAP\Client::checkConnection
     * @method static void checkConnection()
     * @see \Webklex\PHPIMAP\Client::setDefaultAttachmentMask
     * @method static \Webklex\PHPIMAP\Client setDefaultAttachmentMask($mask)
     * @see \Webklex\PHPIMAP\Traits\HasEvents::getEvents
     * @method static array getEvents()
     * @see \Webklex\PHPIMAP\Client::getDefaultMessageMask
     * @method static string getDefaultMessageMask()
     * @see \Webklex\PHPIMAP\ClientManager::get
     * @method static mixed|null get(string $key, null $default = null)
     * @see \Webklex\PHPIMAP\Client::isConnected
     * @method static bool isConnected()
     * @see \Webklex\PHPIMAP\Client::getDefaultEvents
     * @method static array getDefaultEvents($section)
     * @see \Webklex\PHPIMAP\ClientManager::make
     * @method static \Webklex\PHPIMAP\Client make(array $config)
     * @see \Webklex\PHPIMAP\Client::connect
     * @method static \Webklex\PHPIMAP\Client connect()
     * @see \Webklex\PHPIMAP\Client::setDefaultMessageMask
     * @method static \Webklex\PHPIMAP\Client setDefaultMessageMask($mask)
     * @see \Webklex\PHPIMAP\Client::getFolderByName
     * @method static mixed getFolderByName($folder_name)
     * @see \Webklex\PHPIMAP\Traits\HasEvents::getEvent
     * @method static \Webklex\PHPIMAP\Events\Event getEvent($section, $event)
     * @see \Webklex\PHPIMAP\Client::expunge
     * @method static bool expunge()
     * @see \Webklex\PHPIMAP\Client::getQuotaRoot
     * @method static array getQuotaRoot(string $quota_root = 'INBOX')
     * @see \Webklex\PHPIMAP\Client::getQuota
     * @method static array getQuota()
     * @see \Webklex\PHPIMAP\Client::getFolders
     * @method static \Webklex\PHPIMAP\Support\FolderCollection getFolders(bool $hierarchical = true, null|string $parent_folder = null)
     * @see \Webklex\PHPIMAP\ClientManager::setDefaultAccount
     * @method static void setDefaultAccount(string $name)
     * @see \Webklex\PHPIMAP\ClientManager::account
     * @method static \Webklex\PHPIMAP\Client account(string $name = null)
     */
    class Client {}
}
